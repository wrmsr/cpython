...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_internal.h *****/
...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_init.c *****/
...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_insert.c *****/
...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_cleanup.c *****/
...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_query.c *****/
...
/***** lfds_list_addonly_singlylinked_unordered/lfds_list_addonly_singlylinked_unordered_get.c *****/
...
/***** lfds_stack/lfds_stack_internal.h *****/
...
/***** lfds_stack/lfds_stack_cleanup.c *****/
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_internal.h *****/
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_init.c *****/
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_insert.c *****/
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_query.c *****/
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_cleanup.c *****/
...
{
  enum lfds_btree_au_delete_action
    delete_action = LFDS_BTREE_AU_DELETE_SELF; // TRD : to remove compiler warning
  ...
  */
  ...
  while( baue != NULL )
  {
    if( baue->left == NULL and baue->right == NULL )
      delete_action = LFDS_BTREE_AU_DELETE_SELF;

    if( baue->left != NULL and baue->right == NULL )
      delete_action = LFDS_BTREE_AU_DELETE_SELF_REPLACE_WITH_LEFT_CHILD;

    if( baue->left == NULL and baue->right != NULL )
      delete_action = LFDS_BTREE_AU_DELETE_SELF_REPLACE_WITH_RIGHT_CHILD;

    if( baue->left != NULL and baue->right != NULL )
      delete_action = LFDS_BTREE_AU_DELETE_MOVE_LEFT;

    switch( delete_action )
    {
      case LFDS_BTREE_AU_DELETE_SELF:
      ...
      case LFDS_BTREE_AU_DELETE_SELF_REPLACE_WITH_LEFT_CHILD:
      ...
      case LFDS_BTREE_AU_DELETE_SELF_REPLACE_WITH_RIGHT_CHILD:
...
/***** lfds_btree_addonly_unbalanced/lfds_btree_addonly_unbalanced_get.c *****/
...
/***** private prototypes *****/
static void lfds_btree_au_internal_inorder_walk_from_largest_get_next_smallest_element( struct lfds_btree_au_element **baue );
static void lfds_btree_au_internal_inorder_walk_from_smallest_get_next_largest_element( struct lfds_btree_au_element **baue );
                                               ...
                                               enum lfds_btree_au_absolute_position absolute_position )
{
  ...
  *baue = baus->root;
  ...
  {
    case LFDS_BTREE_AU_ABSOLUTE_POSITION_ROOT:
    break;

    case LFDS_BTREE_AU_ABSOLUTE_POSITION_LARGEST_IN_TREE:
      if( *baue != NULL )
    ...
    case LFDS_BTREE_AU_ABSOLUTE_POSITION_SMALLEST_IN_TREE:
      if( *baue != NULL )
                                               ...
                                               enum lfds_btree_au_relative_position relative_position )
{
  ...
  {
    case LFDS_BTREE_AU_RELATIVE_POSITION_UP:
      *baue = (*baue)->up;
      // TRD : no load barrier - up already existed, so is known to be safely propagated
    break;

    case LFDS_BTREE_AU_RELATIVE_POSITION_LEFT:
      *baue = (*baue)->left;
      LFDS_MISC_BARRIER_LOAD;
    break;

    case LFDS_BTREE_AU_RELATIVE_POSITION_RIGHT:
      *baue = (*baue)->right;
      LFDS_MISC_BARRIER_LOAD;
    break;

    case LFDS_BTREE_AU_RELATIVE_POSITION_SMALLEST_ELEMENT_BELOW_CURRENT_ELEMENT:
      *baue = (*baue)->left;
      if( *baue != NULL )
      {
        LFDS_MISC_BARRIER_LOAD;
    ...
    case LFDS_BTREE_AU_RELATIVE_POSITION_LARGEST_ELEMENT_BELOW_CURRENT_ELEMENT:
      *baue = (*baue)->right;
      if( *baue != NULL )
      {
        LFDS_MISC_BARRIER_LOAD;
    ...
    case LFDS_BTREE_AU_RELATIVE_POSITION_NEXT_SMALLER_ELEMENT_IN_ENTIRE_TREE:
      lfds_btree_au_internal_inorder_walk_from_largest_get_next_smallest_element( baue );
    break;

    case LFDS_BTREE_AU_RELATIVE_POSITION_NEXT_LARGER_ELEMENT_IN_ENTIRE_TREE:
      lfds_btree_au_internal_inorder_walk_from_smallest_get_next_largest_element( baue );
    break;
  }
...
{
  enum lfds_btree_au_move
    action = LFDS_BTREE_AU_MOVE_INVALID;

  enum lfds_misc_flag
    finished_flag = LFDS_MISC_FLAG_LOWERED,
    load_finished_flag = LFDS_MISC_FLAG_LOWERED;
  ...
  */
  ...
  while( load_finished_flag == LFDS_MISC_FLAG_LOWERED )
  {
    left = (*baue)->left;
    right = (*baue)->right;
    up = (*baue)->up;
    ...
    if( left == (*baue)->left and right == (*baue)->right and (up == NULL or (up != NULL and up == (*baue)->up and up_left == (*baue)->up->left and up_right == (*baue)->up->right)) )
      load_finished_flag = LFDS_MISC_FLAG_RAISED;
  }

  if( left != NULL )
    action = LFDS_BTREE_AU_MOVE_LARGEST_FROM_LEFT_CHILD;

  if( left == NULL and up != NULL and up_right == *baue )
    action = LFDS_BTREE_AU_MOVE_GET_PARENT;

  if( (left == NULL and up == NULL) or (up != NULL and up_left == *baue and left == NULL) )
    action = LFDS_BTREE_AU_MOVE_MOVE_UP_TREE;

  switch( action )
  {
    case LFDS_BTREE_AU_MOVE_INVALID:
    case LFDS_BTREE_AU_MOVE_SMALLEST_FROM_RIGHT_CHILD:
      // TRD : eliminates a compiler warning
    break;

    case LFDS_BTREE_AU_MOVE_LARGEST_FROM_LEFT_CHILD:
      *baue = left;
      if( *baue != NULL )
      {
        LFDS_MISC_BARRIER_LOAD;
    ...
    case LFDS_BTREE_AU_MOVE_GET_PARENT:
      *baue = up;
    break;

    case LFDS_BTREE_AU_MOVE_MOVE_UP_TREE:
      while( finished_flag == LFDS_MISC_FLAG_LOWERED )
      {
        load_finished_flag = LFDS_MISC_FLAG_LOWERED;
...
static void lfds_btree_au_internal_inorder_walk_from_smallest_get_next_largest_element( struct lfds_btree_au_element **baue )
{
  ...
  */
  ...
  if( right != NULL )
    action = LFDS_BTREE_AU_MOVE_SMALLEST_FROM_RIGHT_CHILD;
...
/***** lfds_freelist/lfds_freelist_internal.h *****/
...
/***** lfds_freelist/lfds_freelist_query.c *****/
...
/***** lfds_freelist/lfds_freelist_pop.c *****/
...
/***** lfds_freelist/lfds_freelist_cleanup.c *****/
...
/***** lfds_freelist/lfds_freelist_init.c *****/
...
/***** lfds_freelist/lfds_freelist_push.c *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_internal.h *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_dequeue.c *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_cleanup.c *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_query.c *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_init.c *****/
...
/***** lfds_queue_bounded_singleproducer_singleconsumer/lfds_queue_bounded_singleproducer_singleconsumer_enqueue.c *****/
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_internal.h *****/
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_insert.c *****/
                                                             ...
                                                             struct lfds_list_aso_element **existing_lasoe )
{
  ...
  LFDS_PAL_ASSERT( (lfds_pal_uint_t) &lasoe->next % LFDS_PAL_ALIGN_SINGLE_POINTER == 0 );
  LFDS_PAL_ASSERT( (lfds_pal_uint_t) &lasoe->value % LFDS_PAL_ALIGN_SINGLE_POINTER == 0 );
  ...
  */
  ...
  while( finished_flag == LFDS_MISC_FLAG_LOWERED )
  {
    ...
    if( compare_result == 0 )
    {
      ...
      {
        case LFDS_LIST_ASO_EXISTING_KEY_OVERWRITE:
          LFDS_LIST_ASO_SET_VALUE_IN_ELEMENT( *lasoe_temp, lasoe->value );
          return LFDS_LIST_ASO_INSERT_RESULT_SUCCESS_OVERWRITE;
        break;

        case LFDS_LIST_ASO_EXISTING_KEY_FAIL:
          return LFDS_LIST_ASO_INSERT_RESULT_FAILURE_EXISTING_KEY;
        break;
      }
    ...
    if( compare_result < 0 )
    {
      ...
      LFDS_MISC_BARRIER_STORE;
      LFDS_PAL_ATOMIC_CAS( &lasoe_trailing->next, (struct lfds_list_aso_element **) &lasoe->next, lasoe, LFDS_MISC_CAS_STRENGTH_WEAK, result );

      if( result == 1 )
        finished_flag = LFDS_MISC_FLAG_RAISED;
      else
      {
        LFDS_BACKOFF_EXPONENTIAL_BACKOFF( lasos->insert_backoff, backoff_iteration );
  ...
  LFDS_BACKOFF_AUTOTUNE( lasos->insert_backoff, backoff_iteration );

  return LFDS_LIST_ASO_INSERT_RESULT_SUCCESS;
}
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_query.c *****/
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_init.c *****/
...
{
  LFDS_PAL_ASSERT( lasos != NULL );
  LFDS_PAL_ASSERT( (lfds_pal_uint_t) &lasos->dummy_element % LFDS_PAL_ATOMIC_ISOLATION_IN_BYTES == 0 );
  LFDS_PAL_ASSERT( (lfds_pal_uint_t) &lasos->start % LFDS_PAL_ATOMIC_ISOLATION_IN_BYTES == 0 );
  LFDS_PAL_ASSERT( key_compare_function != NULL );
  // TRD : existing_key can be any value in its range
  // TRD : user_state can be NULL
  ...
  lfds_misc_internal_backoff_init( &lasos->insert_backoff );
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_get.c *****/
...
/***** lfds_list_addonly_singlylinked_ordered/lfds_list_addonly_singlylinked_ordered_cleanup.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_internal.h *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_cleanup.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_query.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_insert.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_get.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_iterate.c *****/
...
/***** lfds_hash_addonly/lfds_hash_addonly_init.c *****/
                                                        ...
                                                        void *user_state )
{
  ...
  for( loop = 0 ; loop < array_size ; loop++ )
    lfds_btree_au_init_valid_on_current_logical_core( has->baus_array+loop, key_compare_function, btree_au_existing_key, user_state );
...
/***** lfds_prng/lfds_prng_internal.h *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_internal.h *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_query.c *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_enqueue.c *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_init.c *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_cleanup.c *****/
...
/***** lfds_queue_bounded_manyproducer_manyconsumer/lfds_queue_bounded_manyproducer_manyconsumer_dequeue.c *****/
...
/***** lfds_ringbuffer/lfds_ringbuffer_internal.h *****/
...
/***** lfds_ringbuffer/lfds_ringbuffer_cleanup.c *****/
...
/***** lfds_ringbuffer/lfds_ringbuffer_write.c *****/
...
/***** lfds_ringbuffer/lfds_ringbuffer_read.c *****/
...
/***** lfds_ringbuffer/lfds_ringbuffer_init.c *****/
                                                            ...
                                                            void *user_state )
{
  ...
  lfds_freelist_init_valid_on_current_logical_core( &rs->fs, NULL, 0, rs );
...
/***** lfds_ringbuffer/lfds_ringbuffer_query.c *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_internal.h *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_query.c *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_enqueue.c *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_dequeue.c *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_init.c *****/
...
/***** lfds_queue_unbounded_manyproducer_manyconsumer/lfds_queue_unbounded_manyproducer_manyconsumer_cleanup.c *****/
...
/***** lfds_misc/lfds_misc_internal.h *****/
...
/***** private prototypes *****/
void lfds_misc_prng_internal_big_slow_high_quality_init( int long long unsigned seed );





/***** lfds_misc/lfds_misc_query.c *****/
...
/****************************************************************************/
void lfds_misc_query( enum lfds_misc_query query_type,
                         void *query_input,
                         void *query_output )
{
  ...
  switch( query_type )
  {
    case LFDS_MISC_QUERY_GET_BUILD_AND_VERSION_STRING:
    {
      char static const
        * const build_and_version_string = "liblfds " LFDS_MISC_VERSION_STRING " (" BUILD_TYPE_STRING ", " LFDS_PAL_OS_STRING ", " MODE_TYPE_STRING ", " LFDS_PAL_PROCESSOR_STRING ", " LFDS_PAL_COMPILER_STRING ")";
...
/***** lfds_misc/lfds_misc_internal_backoff_init.c *****/
